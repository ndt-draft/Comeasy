...
class Adribbon_Ad_300_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            'Adribbon Ad 300 Widget',
            array('description' => __('Displays Ad 300x150 Sidebar Widget', 'adribbon'))
        );
    }
    ...
    public function form($instance) {
        $instance = wp_parse_args((array) $instance, array(
            'title' => '',
            'image1' => 'http://placehold.it/300x150',
            'url1' => '#',
            'title1' => 'Click to view this advertising.',
            'image2' => 'http://placehold.it/300x150',
            'url2' => '#',
    ...
    ?>
        ...
        <p>
        <label for="<?php echo $this->get_field_id( 'image1' ); ?>"><?php _e( 'Image Link 1 (300x150):', 'adribbon' ); ?></label> 
        ...
        <p>
        <label for="<?php echo $this->get_field_id( 'image2' ); ?>"><?php _e( 'Image Link 2 (300x150)', 'adribbon' ); ?></label> 
    ...
    public function widget($args, $instance) { 
        ...
        echo $before_widget;
            ...
            <div class="ad-area-300 clearfix">
